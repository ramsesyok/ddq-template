...
版・調査条件は progress.md を参照。`template/VERSION` は 2.2.1、Cargo package version は 0.0.0。
...
| .github/workflows、extension/package.json、docs/manual | ビルドと配布の境界を調査 |
...
| extension/src、migration、examples の全本文 | CLI 本体ではない。呼出しやテスト入力の範囲のみ |
