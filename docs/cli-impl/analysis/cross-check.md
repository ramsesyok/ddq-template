...
| 対象版 | 調査中の2.2.1への更新を差分照合。最終コミット02672ebを採用 |
...
| 不明事項 | U-0001～U-0007を定義し、理由・影響・次の確認を掲載 |
